        ...
        <div class="col-sm-12 text-center">
            <div class="btn-group" role="group" >
                ...
                @if($Support[0]->Status!=0)
                    <button type="button" class="btn btn-outline-dark SupportTicketClose"><i class="fa fa-check-circle" aria-hidden="true"></i> Close</button>
                @endif
                                                                ...
                                                                <?php 
                                                                    if(file_exists($SupportDetails[$i]->Attachments[$j]->UploadUrl)){
                                                                        ...
                                                                        if(in_array($ext,array('jpeg','jpg','png','gif','webp','bmp'))){
                                                                            echo '<a href="'.url("/")."/".$SupportDetails[$i]->Attachments[$j]->UploadUrl.'" data-fancybox="Image-1" data-caption="'.$SupportDetails[$i]->Attachments[$j]->UploadFileName.'"><img class="b-r-5"  src="'.url("/")."/".$SupportDetails[$i]->Attachments[$j]->UploadUrl.'"></a>';
                                                                        }elseif($ext=="mp4"){
                                                                            echo '<a href="'.url("/")."/".$SupportDetails[$i]->Attachments[$j]->UploadUrl.'" data-fancybox="Videos" data-caption="'.$SupportDetails[$i]->Attachments[$j]->UploadFileName.'"><video class="b-r-5"  style="cursor:pointer" width="100%"><source src="'.url("/")."/".$SupportDetails[$i]->Attachments[$j]->UploadUrl.'" ></video></a>';
                                                                        }else{
                                                                            echo '<a data-fancybox data-type="iframe" data-src="'.url("/")."/".$SupportDetails[$i]->Attachments[$j]->UploadUrl.'" href="javascript:;">'.$SupportDetails[$i]->Attachments[$j]->UploadFileName.'</a>';
                                                                        }
                                                                    }
                                                                ?>
                                                            </div>
