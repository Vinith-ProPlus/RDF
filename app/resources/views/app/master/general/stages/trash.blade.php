				...
				<div class="card-body " >
					<div class="row">
						<div class="col-12 col-sm-12 col-lg-12">
							<table class="table {{$Theme['table-size']}}" id="tblDropPoint">
								<thead>
									<tr>
										<th class="text-center">Drop Point ID</th>
										<th class="text-center">Drop Point Name</th>
            	...
            	$.ajax({
                    ...
                    success:function(response){
                    	...
                    	if(response.status==true){
                    		$('#tblDropPoint').DataTable().ajax.reload();
