                ...
                if(PostalCode!=""){
                    ...
                    if(response.length>0){
                        ...
                        for(let Item of response){
                            ...
                            $('#lstCity').append('<option '+selected+' data-postal="'+Item.PostalID+'" data-district="'+Item.DistrictID+'" data-state="'+Item.StateID+'" data-country="'+Item.CountryID+'" data-city-name="'+Item.CityName+'" value="'+Item.CityID+'">'+Item.CityName+' </option>');
                        }
                        $('#lstCity').select2();
                        if($('#lstCity').val()!=""){
