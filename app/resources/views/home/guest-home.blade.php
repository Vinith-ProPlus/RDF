...
<head>
    ...
    <title>Royal Dry Fruits</title>

    <meta name="keywords" content="HTML5 Template" />
    <meta name="description" content="Royal Dry Fruits">
                ...
                <div class="container">
                    <div class="header-left col-lg-2 w-auto pl-0">
                        ...
                        <a href="demo42.html" class="logo">
							<img src="{{url('/')}}/{{$Company['Logo']}}" width="50" height="50" alt="Royal Dry Fruits">
                        </a>
						<span class="ml-3 font-weight-bold">Royal Dry Fruits</span>
                    </div><!-- End .header-left -->
            ...
            <div class="container">
                <div class="footer-bottom d-sm-flex align-items-center bg-dark">
                    <div class="footer-left">
                        <span class="footer-copyright">Royal Dry Fruits. © 2024. All Rights Reserved</span>
                    </div>
			...
			<div class="col-sm-7">
				<div class="row justify-content-center mt-3">
					<div class="col-6">
						...
						<span class="ml-3 font-weight-bold text-dark">Royal Dry Fruits</span>
					</div>
				</div>
