...
Route::middleware([AuthenticateWithToken::class])->group(function () {
    Route::post('/customer/payment/gateway/details', [CustomerAPIController::class, 'paymentGatewayDetails']);
    ...
    Route::post('/customer/homeSearch', [CustomerAPIController::class, 'customerHomeSearch'])->name('customerHomeSearch');
...
//    Order
    ...
    Route::post('/order/update/delivered-status', [CustomerAuthController::class, 'updateDeliveredStatus']);
...
Route::post('/guest/homeSearch', [CustomerAPIController::class, 'guestHomeSearch'])->name('guestHomeSearch');
