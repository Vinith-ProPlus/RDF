...
class ProductsController extends Controller
{
	...
	private function getProduct($ProductID){
        $sql="SELECT P.ProductID, P.Slug, P.ProductName, P.ProductType, P.Stages, P.HSNSAC, P.ProductCode, P.VideoURL, P.CTID, CT.PCTName, P.CID, C.PCName, P.SCID, SC.PSCName, P.UID, U.UName, U.UCode, P.TaxType, P.TaxID, P.PRate, P.SRate, P.Decimals, P.Description, ";
